...
// but its real products live elsewhere: cmake-lib/cmake-toolchain
// (rules/c/cmake/index.js), asset (rules/asset/index.js), stampFile labels
// (//rules/gen). Odin is graph-native and exposes [BUILD] directly (see
// //rules/odin) rather than registering a legacy product here. This file
// just declares the goal explicitly so it's documented here rather than
// relying solely on the Rust default; goal registration is
