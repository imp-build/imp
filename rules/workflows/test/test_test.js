		...
		await testGoal([
			{
				id: a.__id,
				address: "//:a",
				kind: "test-workflow-test-a",
				product: "test",
			},
			{
				id: b.__id,
				address: "//:b",
				kind: "test-workflow-test-b",
				product: "test",
			},
		]);
