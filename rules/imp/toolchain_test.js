...
import { Toolchain, TOOLCHAIN, productFor, toolName, __resetToolchainDefaultsForTest } from "imp:core";
...
test("subclasses must declare a tool token", () => {
    ...
    expect(() => new NoTool({ kind: NoTool.kind, attrs: {} }))
        .toThrow("must declare 'static tool");
});
