...
use crate::cache::{
    artifact_relative_path, digest_bytes, digest_json, disable_task_cache,
    evaluate_task_cache_with_lookup, ingest_task_outputs, materialize_cached_outputs,
    materialize_embedded_output_task, materialize_task_outputs_without_record,
    named_cache_key_path, prepare_sandbox, resolve_sandbox_path, store_file_blob,
    write_task_cache_record, TaskCacheEvaluation, TaskCacheRecord, TaskCacheSummary,
    TASK_CACHE_VERSION,
};
use crate::exec::{
    exec_run_inner, exec_run_unsandboxed, materialize_tools_into_sandbox, parse_io_specs,
    parse_tool_specs, report_process_failure, sandbox_command_env, wait_for_child_output,
    ExecIoSpec, ExecRunOpts, ExecToolSpec,
};
use crate::loader::{
...
mod tests {
    ...
    use crate::cache::{explain_task_cache, format_cache_explanation, named_cache_bindings};
