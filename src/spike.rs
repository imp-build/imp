...
use crate::cache::{
    ...
    create_sandbox_root, digest_bytes, digest_json, directory_entries, disable_task_cache,
    evaluate_task_cache_with_lookup, file_mode, ingest_task_outputs, materialize_cached_outputs,
    materialize_embedded_output_task, materialize_task_outputs_without_record,
    named_cache_key_path, prepare_sandbox, resolve_sandbox_path, store_file_blob, task_record_path,
    write_task_cache_record, CachedArtifact, CacheInputDigest, TaskCacheEvaluation,
    TaskCacheRecord, TaskCacheSummary, TASK_CACHE_VERSION,
};
use crate::loader::{
